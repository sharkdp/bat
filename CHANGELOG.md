...
## Bugfixes
- Add support for C23 digit separators in C files (`100'000` was treated as a character literal and broke highlighting for the rest of the line). Closes #3553, see #3913 (@w1977-0)
