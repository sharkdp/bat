...
## Bugfixes
- Reject self-referential custom syntax scope includes during cache builds, preventing unbounded highlighting recursion. Closes #3878, see #3879 (@jackwalkerlabs)
